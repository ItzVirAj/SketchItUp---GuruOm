...
export const CTA_PERMISSION_TABLE: CtaPermission[] = [
  ...
  { ctaId: 'GENERATE_DELIVERY_CHALLAN', label: 'Generate Delivery Challan', stage: 'Stage 9a', authorizedRoles: ['Dispatch Executive', 'Accountant', 'Owner'], preCondition: 'Invoice generated', resultingStatus: 'DISPATCH_READY' },
