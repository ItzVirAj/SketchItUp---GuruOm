                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3.5 py-2 rounded-xl border text-xs outline-none transition-all ${
                      isDarkMode ? 'bg-black/60 border-white/10 text-white focus:border-[#5B75F8]' : 'bg-slate-50 border-slate-200 text-slate-900 focus:border-[#5B75F8]'
                    }`}
                  />
                </div>
                <div>
            ...
            <div className="space-y-3 overflow-y-auto flex-1 text-xs">
              <div className={`p-4 rounded-2xl border space-y-2.5 ${
                ...
                <div className="flex justify-between items-center font-semibold">
                  <span className="text-[#5B75F8] dark:text-[#7B92FF]">{selectedReport.certificateNo || 'PDI-COC-2026-001'}</span>
