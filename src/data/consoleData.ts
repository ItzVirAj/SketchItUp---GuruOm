...
export const initialVendors: VendorMaster[] = [
  {
    ...
    legalName: "Shree Steel Suppliers Pvt Ltd",
    vendorType: "Supplier",
    vendorCategory: "Raw Material",
    contactPerson: "Mahesh Shetty",
    mobile: "9850011111",
    email: "mahesh@example.com",
    billingAddress: "MIDC Bhosari, Pune, Maharashtra 411026",
    address: "MIDC Bhosari, Pune, Maharashtra 411026",
    city: "Pune",
    state: "Maharashtra",
    stateCode: "27",
    ...
    pan: "AAAFS1111A",
    bankAccountName: "Shree Steel Suppliers",
    bankAccountNumber: "5020012345678",
    ifsc: "HDFC0001234",
    paymentTerms: "Net 30",
    creditDays: 30,
    creditLimit: 2000000,
    status: "Active",
    notes: "MS plates & rounds."
  },
  {
    id: "v-VEND-0002",
    code: "VEND-0002",
    name: "ABC Heat Treaters",
    legalName: "ABC Heat Treaters",
    vendorType: "Subcontractor / Job Worker",
    vendorCategory: "Maintenance",
    contactPerson: "Ashok Bhagat",
    mobile: "9850066666",
    email: "ashok@example.com",
    billingAddress: "Chakan Industrial Area, Pune, Maharashtra 410501",
    ...
    pan: "AAFFA6666F",
    bankAccountName: "ABC Heat Treaters",
    bankAccountNumber: "5020098765",
    ifsc: "HDFC0002233",
    paymentTerms: "Net 15",
    creditDays: 15,
    creditLimit: 0,
    status: "Active",
    notes: "Job-work vendor for heat treatment — TAT 2 days."
  },
  {
    id: "v-VEND-0003",
    code: "VEND-0003",
    name: "Reliable Transport Co.",
    legalName: "Reliable Transport Co.",
    vendorType: "Transporter",
    vendorCategory: "Transport / Logistics",
    contactPerson: "Santosh More",
    mobile: "9850088888",
    email: "santosh@example.com",
    billingAddress: "Old Pune-Mumbai Highway, Pune, Maharashtra 411018",
    ...
    pincode: "411018",
    pin: "411018",
    gstin: "N/A — GST-exempt (below threshold)",
    pan: "AAHFR8888H",
    bankAccountName: "Reliable Transport Co.",
    ...
    creditLimit: 0,
    status: "Active",
    notes: "Service area: Pune-Mumbai-Nashik belt."
  },
  {
    id: "v-VEND-0004",
    code: "VEND-0004",
    name: "Om Engineering Consumables",
    legalName: "Om Engineering Consumables",
    vendorType: "Supplier",
    vendorCategory: "Consumables",
    contactPerson: "Prakash More",
    mobile: "9850011122",
    ...
    pan: "AAOFE1122A",
    bankAccountName: "Om Engineering Consumables",
    bankAccountNumber: "5020033445566",
    ifsc: "HDFC0001235",
    paymentTerms: "Net 30",
    creditDays: 30,
    creditLimit: 500000,
    status: "Active",
    notes: "Cutting tools, coolant, PPE."
  },
  {
    id: "v-VEND-0005",
    code: "VEND-0005",
    name: "Precision Tooling Solutions",
    legalName: "Precision Tooling Solutions Pvt Ltd",
    vendorType: "EquipmentVendor",
    vendorCategory: "Machinery",
    contactPerson: "Deepak Bhosale",
    mobile: "9850022233",
    ...
    pan: "AABPT2233B",
    bankAccountName: "Precision Tooling Solutions",
    bankAccountNumber: "5020044556677",
    ifsc: "HDFC0002234",
    paymentTerms: "Net 45",
    creditDays: 45,
    creditLimit: 3000000,
    status: "Active",
    notes: "Machine tool and fixture supplier."
  },
  {
    id: "v-VEND-0006",
    code: "VEND-0006",
    name: "Vishal Manpower Services",
    legalName: "Vishal Manpower Services",
    vendorType: "ManpowerProvider",
    vendorCategory: "Manpower",
    contactPerson: "Vishal Gaikwad",
    mobile: "9850033344",
    email: "vishal.g@example.com",
    billingAddress: "Pimpri, Pune, Maharashtra 411018",
    ...
    gstin: "N/A — GST-exempt (below threshold)",
    pan: "AAAFV3344C",
    bankAccountName: "Vishal Manpower Services",
    bankAccountNumber: "5020055667788",
    ifsc: "UBIN0801235",
    paymentTerms: "Net 15",
    creditDays: 15,
    creditLimit: 0,
    status: "Active",
    notes: "Contract labour for shop floor."
  },
  {
    id: "v-VEND-0007",
    code: "VEND-0007",
    name: "Bytewise IT Solutions",
    legalName: "Bytewise IT Solutions Pvt Ltd",
    vendorType: "Service Provider",
    vendorCategory: "IT / Software",
    contactPerson: "Kunal Shah",
    mobile: "9850044455",
    email: "kunal.shah@example.com",
    billingAddress: "Baner, Pune, Maharashtra 411045",
    ...
    pan: "AABBI4455D",
    bankAccountName: "Bytewise IT Solutions",
    bankAccountNumber: "5020066778899",
    ifsc: "HDFC0003345",
    paymentTerms: "Net 30",
    creditDays: 30,
    creditLimit: 0,
    status: "Active",
    notes: "Annual IT support & network AMC."
  },
  {
    id: "v-VEND-0008",
    code: "VEND-0008",
    name: "Accura Legal & Tax Advisors",
    legalName: "Accura Legal & Tax Advisors",
    vendorType: "Professional Service",
    vendorCategory: "Professional Services",
    contactPerson: "Radhika Nair",
    mobile: "9850055566",
    email: "radhika.nair@example.com",
    billingAddress: "Deccan Gymkhana, Pune, Maharashtra 411004",
    ...
    pan: "AABPA5566E",
    bankAccountName: "Accura Legal & Tax Advisors",
    bankAccountNumber: "5020077889900",
    ifsc: "HDFC0004456",
    paymentTerms: "Net 15",
    creditDays: 15,
    creditLimit: 0,
    status: "Active",
    notes: "GST filing and compliance retainer."
  },
  {
    id: "v-VEND-0009",
    code: "VEND-0009",
    name: "Sagar Packaging Industries",
    legalName: "Sagar Packaging Industries",
    vendorType: "Supplier",
    vendorCategory: "Packaging",
    contactPerson: "Sagar Wagh",
    mobile: "9850066677",
    email: "sagar.wagh@example.com",
    billingAddress: "Talegaon MIDC, Pune, Maharashtra 410507",
    ...
    pan: "AABSP6677F",
    bankAccountName: "Sagar Packaging Industries",
    bankAccountNumber: "5020088990011",
    ifsc: "HDFC0005567",
    paymentTerms: "Net 30",
    creditDays: 30,
    creditLimit: 600000,
    status: "Active",
    notes: "Corrugated boxes and export crating."
  },
  {
    id: "v-VEND-0010",
    code: "VEND-0010",
    name: "Neptune CNC Job Works",
    legalName: "Neptune CNC Job Works",
    vendorType: "Subcontractor / Job Worker",
    vendorCategory: "Machinery",
    contactPerson: "Nitin Kadam",
    mobile: "9850077788",
    email: "nitin.kadam@example.com",
    billingAddress: "Ranjangaon MIDC, Pune, Maharashtra 412220",
    ...
    pan: "AABNC7788G",
    bankAccountName: "Neptune CNC Job Works",
    bankAccountNumber: "5020099001122",
    ifsc: "HDFC0006678",
    paymentTerms: "Net 15",
    creditDays: 15,
    creditLimit: 0,
    status: "Active",
    notes: "Outsourced CNC turning — TAT 3 days."
  }
];
...
export const initialMachines: MachineMaster[] = [
  {
    ...
    shift: "General-Day",
    status: "Active",
    responsiblePerson: "Vijay Shinde",
    hourlyCost: 500,
    active: true
  },
  {
    ...
    shift: "Shift A",
    status: "Active",
    responsiblePerson: "Prakash Jadhav",
    hourlyCost: 500,
    active: true
  },
  {
    ...
    shift: "Shift A",
    status: "Active",
    responsiblePerson: "Suresh Yadav",
    hourlyCost: 500,
    active: true
  },
  {
    ...
    shift: "Shift B",
    status: "Active",
    responsiblePerson: "Ravindra Kale",
    hourlyCost: 500,
    active: true
  },
  {
    ...
    department: "Fabrication & Welding",
    location: "Shed 1",
    manufacturer: "Jindal Machines",
    model: "JMC Shear-6",
    serialNumber: "JMC-SH6-3341",
    installationDate: "2016-04-02",
    capacity: 2000,
    capacityUom: "mm",
    operatingHours: 8,
    shift: "General-Day",
  ...
  },
  {
    ...
    shift: "General-Day",
    status: "Active",
    responsiblePerson: "Snehal Bhosale",
    hourlyCost: 500,
    active: true
  },
  {
  ...
  },
  {
    ...
    code: "MCH-0008",
    name: "CONV-01",
    type: "Conventional Machining",
    department: "Machining",
    location: "Shed 1",
    manufacturer: "HMT",
    model: "Lathe LB-20",
    serialNumber: "HMT-LB20-4521",
    installationDate: "2012-01-10",
    capacity: 500,
    capacityUom: "mm",
    operatingHours: 8,
    shift: "Shift B",
  ...
  },
  {
    ...
    serialNumber: "ESAB-REMP-6612",
    installationDate: "2019-08-08",
    capacityUom: "Ton",
    operatingHours: 8,
    shift: "Shift A",
    status: "Active",
    responsiblePerson: "Ashok Bhagat",
    hourlyCost: 500,
    active: true
  },
  {
